          ...
          <>
                <section className="border-b border-border">
                        <div className="mx-auto max-w-[1600px] px-6 md:px-10 pt-16 md:pt-24 pb-16">
                                  <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-8">{T.about.badge}</p>
                                  <h1 className="font-display text-[clamp(3rem,11vw,11rem)] font-light tracking-[-0.05em] leading-[0.9]">
                                    {T.about.h1a}<br /><span className="text-muted-foreground">{T.about.h1b}</span><br />{T.about.h1c}
                                  </h1>
                        </div>
                </section>
                ...
                <section className="border-b border-border">
                        <div className="mx-auto max-w-[1600px] px-6 md:px-10 py-20 md:py-28 grid md:grid-cols-12 gap-10">
                            ...
                            i === 0
                              ? <span key={i}>{part}<Link to="/work/street" className="link-underline font-medium">{T.nav.street}</Link></span>
                              : <span key={i}>{part.replace('Personal', '')}<Link to="/work/personal" className="link-underline font-medium">{T.nav.personal}</Link>{part.includes('Personal') ? part.split('Personal')[1] : ''}</span>
                                                            )}
                                              </p>
                                              <div className="pt-8 border-t border-border grid grid-cols-2 gap-8 text-sm">
                                                            <div>
                                                                            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-2">{T.about.gearLabel}</p>
                                                                            <p>{T.about.gear}</p>
                                                            </div>
                                                            <div>
                                                                            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-2">{T.about.citiesLabel}</p>
                                                                            <p>{T.about.cities}</p>
                                                            </div>
                                                            <div>
                                                                            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-2">{T.about.languagesLabel}</p>
                                                                            <p>{T.about.languages}</p>
                                                            </div>
                                                            <div>
                                                                            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-2">{T.about.publishedLabel}</p>
                                                                            <p>{T.about.published}</p>
                                                            </div>
                                              </div>
                                  </div>
                        </div>
