    ...
    return (
          <Link to={to} className="group block">
                ...
                <div className="flex items-end justify-between">
                        <div>
                                  <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-2">{n}</p>
                                  <h3 className="font-display text-4xl md:text-5xl font-light tracking-[-0.03em]">{title}</h3>
                ...
                <section className="border-b border-border">
                        <div className="mx-auto max-w-[1600px] px-6 md:px-10 pt-16 md:pt-24 pb-16 md:pb-24">
                                  ...
                                  <h1 className="font-display text-[clamp(3.5rem,13vw,13rem)] font-light tracking-[-0.05em] leading-[0.88]">
                                    {T.hero.h1a}<br />
                                              <span className="text-muted-foreground">{T.hero.h1b}</span> {T.hero.h1c}
                                  </h1>
            ...
            {/* MARQUEE STRIP */}
                <section className="border-b border-border overflow-hidden py-6">
                        ...
                        <span key={i} className="inline-flex items-center gap-12">
                          {T.marquee[0]} <span className="text-muted-foreground">✶</span>
                          {T.marquee[1]} <span className="text-muted-foreground">✶</span>
                          {T.marquee[2]} <span className="text-muted-foreground">✶</span>
                          {T.marquee[3]} <span className="text-muted-foreground">✶</span>
                          {T.marquee[4]} <span className="text-muted-foreground">✶</span>
                        </span>
                      ))}
                        </div>
                ...
                <section className="border-b border-border">
                        <div className="mx-auto max-w-[1600px] px-6 md:px-10 py-24 md:py-32">
                                  <div className="grid md:grid-cols-12 gap-10 mb-16 md:mb-24">
                                              <p className="md:col-span-3 text-xs uppercase tracking-[0.2em] text-muted-foreground">{T.twoWays.label}</p>
                                              <h2 className="md:col-span-9 font-display text-[clamp(2.5rem,7vw,6rem)] font-light tracking-[-0.04em] leading-[0.95]">
                                                {T.twoWays.h2a}<br />
                                                            <span className="text-muted-foreground">{T.twoWays.h2b}</span>
                                              </h2>
                                  </div>
                ...
                <section className="border-b border-border bg-secondary">
                        <div className="mx-auto max-w-[1600px] px-6 md:px-10 py-24 md:py-32">
                                  <div className="grid md:grid-cols-12 gap-10">
                                              <p className="md:col-span-3 text-xs uppercase tracking-[0.2em] text-muted-foreground">{T.process.label}</p>
            ...
            {/* CTA */}
                <section>
                        <div className="mx-auto max-w-[1600px] px-6 md:px-10 py-32 md:py-40 text-center">
                                  <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-8">{T.cta.label}</p>
